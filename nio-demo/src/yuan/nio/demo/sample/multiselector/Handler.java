...
import static yuan.nio.demo.sample.multiselector.ServerContext.execute;
import static yuan.nio.demo.sample.multiselector.ServerContext.useThreadPool;
...
public abstract class Handler extends Thread
{
    ...
    private void doRead()
    {
        ...
        log.info("readed from client:" + readData + ", " + readData.length());
    }
    ...
    {
        log.info("process readData=" + readData.toString());
        if (isQuit())
        {
            disconnect();
            return false;
    ...
    private void write()
    {
        ...
        log.info("writed to client:" + writeData + ", " + writeData.length());
        interestOps(State.READING);
    }
