...
public class ServerContext
{
    ...
    private static <T extends Reactor> void start(int port, Class<T> clazz, boolean useMultipleReactors,
        int subReactorSize)
    {
        try
        {
        ...
        try
        {
            Constructor<T> constructor =
                clazz.getConstructor(int.class, ServerSocketChannel.class, boolean.class, boolean.class, long.class);
            ...
            if (useMultipleReactors)
            {
                ...
                {
                    subReactors[i] =
                        constructor.newInstance(port, serverChannel, false, useMultipleReactors, selectTimeOut);
                }
            }
        }
        catch (Exception e)
